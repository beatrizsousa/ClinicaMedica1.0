 ...
 * @author dell
 */
public class AgendarConsulta_recepcionista extends javax.swing.JFrame {

    /**
     * Creates new form TelaAgendarConsulta
     */
    public AgendarConsulta_recepcionista() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgendarConsulta_recepcionista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AgendarConsulta_recepcionista().setVisible(true);
            }
        });
    }
